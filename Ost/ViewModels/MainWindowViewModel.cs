...
using Ost.Services.Store.Config;
using System.Threading.Tasks;
using Ost.ViewModels.WatchOnly;
using System.Collections.ObjectModel;
using Avalonia;
using Avalonia.Controls.ApplicationLifetimes;
using Material.Dialog;
using Avalonia.Controls;
using Ost.ViewModels.NonceAccounts;
using System.Windows.Input;
using Avalonia.Platform;
using Avalonia.Media.Imaging;
using Avalonia.Threading;
using Ost.Services.Wallets.Enums;
using Ost.Services.Enums;
using System.Linq;
using Ost.ViewModels.NameService;
using Ost.ViewModels.NFTs;
using Ost.ViewModels.Forensic;

namespace Ost.ViewModels
{
    /// <summary>
    ...
    public class MainWindowViewModel : ViewModelBase
    {
            ...
            ApplicationState appState, ILogger logger)
        {
            ...
            //using var image = _assetLoader.Open(new("avares://Ost/Assets/Ost.png"));
        ...
        private void InitializeView()
        {
            if (!_keyStore.WalletExists)
            {
                ...
                _importWalletViewModel.Skip.Subscribe(SkipWallet);
            }
        ...
        /// </summary>
        /// <param name="walletImport">The params.</param>
        private void SkipWallet(WalletImport walletImport)
        {
        ...
        private bool _skippedWallets = false;
        public bool SkippedWallets
        {
            get => _skippedWallets;
            set => this.RaiseAndSetIfChanged(ref _skippedWallets, value);
        }
